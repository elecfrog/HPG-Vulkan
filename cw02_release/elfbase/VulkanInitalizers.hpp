...
namespace elf
{
	namespace initializers
	{
		...
		inline labutils::DescriptorSetLayout createDescLayout(const labutils::VulkanWindow& aWindow, VkDescriptorType type, VkShaderStageFlagBits stage, size_t count = 1)
		{
		...
		labutils::PipelineLayout createPipelineLayout(const labutils::VulkanContext& aContext,
