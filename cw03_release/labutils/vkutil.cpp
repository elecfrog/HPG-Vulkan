...
namespace labutils
{
	...
	Sampler createTexturesampler(VulkanContext const& aContext)
	{
		VkSamplerCreateInfo samplerInfo = enit::samplerCreateInfo();
	...
	Sampler createScreenSampler(VulkanContext const& aContext)
	{
		VkSamplerCreateInfo samplerInfo = enit::samplerCreateInfo();
