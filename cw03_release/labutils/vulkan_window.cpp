...
#		endif // ~ debug builds
...

		{
			...
			props2.pNext = &shadingRateProperties;
			vkGetPhysicalDeviceProperties2(ret.physicalDevice, &props2);

			if (shadingRateProperties.layeredShadingRateAttachments)
			{
				enabledExensions.emplace_back(VK_KHR_FRAGMENT_SHADING_RATE_EXTENSION_NAME);
			}
