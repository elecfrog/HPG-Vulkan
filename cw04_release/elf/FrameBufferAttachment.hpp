...
namespace elf
{
	...
	inline FrameBufferAttachment createFBAttachment(labutils::VulkanWindow const& _window, labutils::Allocator const& _allocator, VkFormat format, VkImageUsageFlags usage)
	{
	...
	// [ref: code base of vulkan examples](https://github.com/SaschaWillems/Vulkan/blob/master/examples/)
	inline FrameBufferAttachment createDepthFBAttachment(uint32_t w, uint32_t h, labutils::VulkanWindow const& _window, labutils::Allocator const& _allocator, VkFormat format, VkImageUsageFlags usage)
	{
		VkImageAspectFlags aspectMask = 0;
		uint32_t mipMapLevel = 0;
